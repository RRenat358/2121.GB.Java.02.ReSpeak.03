...
//    private ServerHandler serverHandler = ServerHandler.getInstance();
    ...
    private void authenticate() throws IOException {
        while (true) {
            ...
            if (command.getType() == CommandType.AUTH) {
                ...
                logger.info("Введено: login = {}, password = {}",login, password);

                if (userName == null) {
                    sendCommand(Command.errorCommand("Некорректные логин/пароль"));
                    logger.error("Некорректные логин/пароль");
                    ...
                    logger.info("Авторизован: login = {}, password = {}",login, password);
                    return;
                }
            }
        }
    ...
    public void closeClientConnection() throws IOException {
        ...
        clientSocket.close();
        logger.info("closeClientConnection() = clientSocket {}, getUserName {}", clientSocket, getUserName());
    }
